    ...
    return Column(
      children: [
        Padding(
          ...
          child: const CustomBookImage(imageUrl: 'https://t4.ftcdn.net/jpg/01/10/04/51/360_F_110045173_QgmA3gg5OwTlLNQBqmPdFnkh6sPvsvt8.jpg',),
        ),
        const SizedBox(
          height: 43,
        ),
        ...
        const BookRating(
          mainAxisAlignment: MainAxisAlignment.center, rating: 22, count: 22,
        ),
        const SizedBox(
          height: 37,
        ),
